...
[System.Serializable]
public class KuwaharaPostProcessRenderer : ScriptableRendererFeature
{
    KuwaharaPostProcessPass pass;
    public Material shaderMat;

    public override void Create()
    {
        pass = new KuwaharaPostProcessPass();
        pass.shaderMat = shaderMat;
    }
...
[System.Serializable]
public class KuwaharaPostProcessPass : ScriptableRenderPass
{
    public Material shaderMat;
    ...
    public KuwaharaPostProcessPass()
    {
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        //---Custom effect here---
        var customEffect = stack.GetComponent<KuwaharaEffectComponent>();
        // Only process if the effect is active
        if (customEffect.IsActive())
        {
            var material = shaderMat;
            // P.s. optimize by caching the property ID somewhere else
            material.SetFloat(Shader.PropertyToID("_KernelSize"), customEffect.kernelSize.value);
